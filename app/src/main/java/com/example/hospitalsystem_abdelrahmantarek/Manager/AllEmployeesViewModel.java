...
public class AllEmployeesViewModel extends ViewModel {
    ...
    public void getEmployees(String token){
        getDoctors(doctorsList,token, allEmployeesList);
        getNurses(nursesList, token, allEmployeesList);
        getReceptionists(receptionistsList, token, allEmployeesList);
        getAnalysisEmps(analysisList, token, allEmployeesList);
        getHrs(hrsList, token, allEmployeesList);
        getManagers(managersList, token, allEmployeesList);
