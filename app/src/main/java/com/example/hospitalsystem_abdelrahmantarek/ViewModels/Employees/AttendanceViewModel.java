...
public class AttendanceViewModel extends ViewModel {
    ...
    public void attendance(Context context, String status){
        ...
        RetrofitClient.getClient().attendance(status, employeeModel.getAccessToken()).enqueue(new Callback<SimpleResponse>() {
            @Override
