...
public class EndCaseViewModel extends ViewModel {
    ...
    public void endCase(Context context, int caseId){
        ...
        RetrofitClient.getClient().endCase(caseId, employeeModel.getAccessToken()).enqueue(new Callback<SimpleResponse>() {
            @Override
