...
public class MakeRequestViewModel extends ViewModel {
    ...
    public void makeRequest(Context context, RequestAnlRequest request){
        ...
        RetrofitClient.getClient().makeRequest(request, employeeModel.getAccessToken()).enqueue(new Callback<SimpleResponse>() {
            @Override
