package com.example.hospitalsystem_abdelrahmantarek.ViewModels.Calls;
...
public class CreateCallViewModel extends ViewModel {
    ...
    public void createCall(Context context, CreateCallRequest callRequest){
        ...
        RetrofitClient.getClient().createCall(callRequest, employeeModel.getAccessToken())
