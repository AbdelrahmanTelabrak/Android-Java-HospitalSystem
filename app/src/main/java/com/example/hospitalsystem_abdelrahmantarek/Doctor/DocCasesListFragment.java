                    ...
                    public void onResponse(Call<CasesResponse> call, Response<CasesResponse> response) {
                        if (response.isSuccessful()){
                            if (response.body().isSuccess()){
                                casesListAdaptor = new DocCasesListAdaptor(response.body().getData());
